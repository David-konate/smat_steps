...
const PlayerCard2 = ({ userRanking, shadowColor, borderColor, bgColor }) => {
  return (
    <Card
      title={userRanking.user_pseudo}
      ...
      <CardContent className="player-info" sx={{ textAlign: "center" }}>
        ...
        >
          <Avatar
            ...
            src={displayImage(userRanking.user_image)}
          />
        </Box>
        <Typography mt={2} variant="body1" className="player-pseudo">
          {userRanking.user_pseudo}
        </Typography>
